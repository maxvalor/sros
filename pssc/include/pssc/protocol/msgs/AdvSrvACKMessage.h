...
#ifndef INCLUDE_PSSC_PROTOCOL_MSGS_ADVSRVACKMESSAGE_H_
#define INCLUDE_PSSC_PROTOCOL_MSGS_ADVSRVACKMESSAGE_H_

#include "PSSCMessage.h"

namespace pssc {

class AdvSrvACKMessage : public PSSCMessage
{
public:
    // | INS | ID | SUCCESS |
    ...
    AdvSrvACKMessage() = default; // @suppress("Class members should be properly initialized")

    AdvSrvACKMessage(std::shared_ptr<TCPMessage> msg)
    {
        // INS has been taken
...
#endif /* INCLUDE_PSSC_PROTOCOL_MSGS_ADVSRVACKMESSAGE_H_ */
